				...
				<div class="side-header">
					...
					<nav class="slide-menu">
                                        ...
                                        <ul class="parent-menu">
											...
											<!-- <li><a href="temp/inbox.html" title=""><i class="fa fa-inbox"></i><span>inbox</span><ins>5</ins></a></li>
                                            <li><a href="temp/charts.html" title=""><i class="fa fa-bar-chart"></i><span>charts</span></a></li>
                                            <li> <a href="temp/maps.html" title=""><i class="fa fa-globe"></i><span>Google maps</span></a> </li>
											<li class="menu-item-has-children"> 
												<a title=""><i class="fa fa-flag"></i><span>Icons</span></a>
                                                <ul>
                                                    <li><a href="temp/icons.html">Font Awesome</a></li>
                                                    <li><a href="temp/icons2.html">Themify Icons</a></li>
                                                </ul>
                                            </li> -->
											<!-- <li class="menu-item-has-children active"> <a title=""><i class="fa fa-inbox"></i><span>Pages</span></a>
                                                <ul class="mega" style="display: block;">
                                                    <li><a class="active" href="temp/profile.html">profile</a></li>
                                                    <li><a href="temp/edit-profile.html">edit profile</a></li>
                                                    <li><a href="temp/login.html">login</a></li>
                                                    <li><a href="temp/register.html">register</a></li>
                                                    <li><a href="temp/forgot-pass.html">forgot password</a></li>
                                                </ul>
                                            </li> -->
                                            <!-- <li class="menu-item-has-children"> <a title=""><i class="fa fa-external-link"></i><span>extras</span></a>
                                                <ul class="mega">
                                                    <li><a href="temp/404.html">404 error page</a></li>
                                                    <li><a href="temp/505.html">505 error page</a></li>
                                                    <li><a href="temp/maintenance.html">maintenance</a></li>
                                                    <li><a href="temp/coming-soon.html">coming soon </a></li>
                ...
                <div class="profile">
                  <div class="row merged">
                    <div class="col-md-4 col-sm-12 col-xs-12">
                      <div class="profile-bg"> <img src="temp/images/resources/profile-bg.jpg" alt="">
                        <div class="admin-meta"> <img src="temp/images/resources/profile-avatar.jpg" alt="">
                        ...
                        <div class="col-md-12">
                          <div class="sub-area">
                            <ul>
                              ...
                              <li><a href="{{url('/edit_profile')}}" title=""><i class="fa fa-gear"></i>Account Settings </a></li>
                    ...
                    <div class="widget">
                      ...
                      <div class="widget-peding">
                        <ul class="activity-meta">
                          <li>
                            <div class="activity-ico"> <img src="temp/images/icon-6.html" alt=""> <span>4515 <i>total sales</i></span> </div>
                            <div class="spark">
                              <div class="sparkline11"></div>
                            </div>
                          </li>
                          <li>
                            <div class="activity-ico"> <img src="temp/images/icon-7.html" alt=""> <span>2089<i>new sales</i></span> </div>
                            <div class="spark">
                        ...
                        <table class="member-activity table table-responsive">
                          ...
                          <tbody>
                            <tr>
                              <td><i><img src="temp/images/resources/active-member1.jpg" alt=""></i> <span>tom</span></td>
                              <td>$18</td>
                              <td>65</td>
                              <td>28</td>
                              <td>80%</td>
                            ...
                            <tr>
                              <td><i><img src="temp/images/resources/active-member2.jpg" alt=""></i> <span>rifn</span></td>
                              <td>$198</td>
                              <td>99</td>
                              <td>68</td>
                              <td>90%</td>
                            ...
                            <tr>
                              <td><i><img src="temp/images/resources/active-member3.jpg" alt=""></i> <span>tom</span></td>
                              <td>$18</td>
                              <td>65</td>
                              <td>28</td>
                              <td>80%</td>
                            ...
                            <tr>
                              <td><i><img src="temp/images/resources/active-member4.jpg" alt=""></i> <span>rifn</span></td>
                              <td>$198</td>
                              <td>99</td>
                              <td>68</td>
                              <td>90%</td>
                            ...
                            <tr>
                              <td><i><img src="temp/images/resources/active-member3.jpg" alt=""></i> <span>Daniel</span></td>
                              <td>$198</td>
                              <td>99</td>
                              <td>68</td>
                              <td>90%</td>
                    ...
                    <div class="widget">
                      ...
                      <div class="widget-peding">
                        <ul class="q-comments support">
                          <li>
                            <div class="comenter"> <img src="temp/images/resources/q-comment1.jpg" alt=""> </div>
                    ...
                    <div class="widget">
                      ...
                      <div class="widget-peding">
                        <ul class="q-comments">
                          ...
                          <li>
                            <div class="comenter"> <img src="temp/images/resources/q-comment2.jpg" alt=""> </div>
                            <div class="comment-detail">
                              <h5>Natasha Kim</h5>
                              <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus sc risque ante sollicitudin commodo. </p>
                            </div>
                          ...
                          <li>
                            <div class="comenter"> <img src="temp/images/resources/q-comment3.jpg" alt=""> </div>
                            <div class="comment-detail">
                              <h5>Jason Bourne</h5>
                              <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus sc risque ante sollicitudin commodo. </p>
                            </div>
