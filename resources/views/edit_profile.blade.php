              ...
              <div class="content-area">
                ...
                <div class="inner-bg">
                  <div class="element-title">
                    ...
                    <?php 
				  $id=Auth::user()->id;?>
                    <a href="{{  ('/delete'),['id' => $id]}}" style="float: right;"><i class="fa fa-trash" aria-hidden="true"></i>Delete Account</a>
				  </div>
				  <?php 
				  $id=Auth::user()->id;?>
				  <form role="form" method="post" action="{{ ('/edit') , ['id' => $id]}}">
                     {{ csrf_field() }} 
                    <div class="pnl-bdy billing-sec">
                      ...
                      <div class="col-md-12 col-sm-12 field">
                        ...
                        <input placeholder="" value="<?php echo Auth::user()->email;?>" type="text" name="email">
                      </div>
                      <div class="col-md-12 col-sm-12 field">
